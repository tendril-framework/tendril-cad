...
setup(
    ...
    description="Tendril CAD Primitives and Infrastructure",
    long_description='\n'.join([read('README.rst'), read('CHANGELOG.rst')]),
    long_description_content_type='text/x-rst',
    keywords='tendril',
    url='https://github.com/tendril-framework/tendril-cad',
    project_urls={
        'Documentation': 'https://tendril-cad.readthedocs.io/en/latest',
        'Bug Tracker': 'https://github.com/tendril-framework/tendril-cad/issues',
        'Source Repository': 'https://github.com/tendril-framework/tendril-cad',
    },
